...
namespace Subst
  ...
  := by
    ...
    simp [compose_tuple, compose, act, SubstAction.act]
    congr
  ...
  theorem rewrite7_ren
    ...
    : (σ ∘ r1) ∘ r2 = σ ∘ r1 ∘ r2
  := by simp [compose_ren_right, Ren.compose_tuple]
...
:= by
  ...
  simp [compose_ren_right, Ren.compose_tuple, act, SubstAction.act]; grind
...
:= by
  ...
  simp [compose_ren_right_tuple, compose_ren_left_tuple]; congr
